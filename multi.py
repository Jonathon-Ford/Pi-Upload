...
class MultitagPositioning(object):
    ...
    def printPublishPosition(self, position, network_id):
        ...
        if network_id==0x0000:
            # NOTE: front tag is the tag connected to the Pi(0x673c) and back tag is connected to external power source
            global x_position_front #= position.x;
            global y_position_front #= position.y;
            global z_position_front #= position.z;
            ...
            global x_position_back #= position.x;
            global y_position_back #= position.y;
            global z_position_back #= position.z;
...
if __name__ == "__main__":
    ...
    while True:    
        ...
        print("THE BACK X POSITION IS:" + str(x_position_back)); #used to see if the x-positions of the back tag were correct
        print("THE BACK Y POSITION IS:" + str(y_position_back)); #used to see if the y-positions of the back tag were correct
        print("THE BACK Z POSITION IS:" + str(z_position_back)); #used to see if the z-positions of the back tag were correct
